...
export const deck: TarotCardData[] = majors.map(([name, numeral, meaning, interpretation, past, future, invitation], index) => ({
  ...
  image: `/mileide/cards/rws-${String(index).padStart(2, "0")}.webp`,
  arcana: "major",
}));
